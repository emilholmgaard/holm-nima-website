    ...
    <FadeIn className="lg:order-last">
      <form>
        ...
        <div className="isolate mt-6 -space-y-px rounded-2xl bg-white/50">
          ...
          <TextInput label="Besked" name="message" />
        </div>
  ...
  return (
    <FadeIn>
      ...
      <p className="mt-6 text-base text-neutral-600">
        Foretrækker du at mødes personligt? Vi gør ikke, men vi er forpligtet til at oplyse vores adresser her af juridiske årsager.
      </p>
      ...
      <Border className="mt-16 pt-16">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
          {[
            ['Karriere', 'kontakt@nima.dk'],
            ['Presse', 'presse@nima.dk'],
            ['Telefon', '61 33 00 43'],
            ['Sekretariat', '31 38 37 16'],
          ].map(([label, email]) => (
            <div key={email}>
...
export const metadata: Metadata = {
  title: 'Kontakt os',
  description: 'Lad os arbejde sammen. Vi glæder os til at høre fra dig.',
}

export default function Contact() {
  return (
    <>
      <PageIntro eyebrow="Kontakt os" title="Lad os arbejde sammen">
